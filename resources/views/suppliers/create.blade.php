...
<body class="p-6">
    <div class="max-w-2xl mx-auto">
        <h1 class="page-title mb-8">
            <i class="fas fa-plus-circle mr-3 text-blue-600"></i>Tambah Supplier
        </h1>
        ...
        <div class="form-container">
            <form action="{{ route('suppliers.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" class="form-input" value="{{ old('name') }}" required placeholder="Masukkan nama supplier">
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="phone" class="form-input" value="{{ old('phone') }}" placeholder="08123456789">
                    </div>
                </div>

                <div class="mb-6">
                    <label class="form-label">Alamat</label>
                    <textarea name="address" class="form-input" rows="3" placeholder="Masukkan alamat lengkap">{{ old('address') }}</textarea>
                </div>
