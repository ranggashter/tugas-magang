    ...
    <div class="header-gradient">
        <div class="container">
            <div class="text-center">
                <h1 class="fw-bold mb-0" style="font-size: 2.1rem;"><i class="fas fa-chart-line me-2"></i>Laporan Aktivitas Pengguna</h1>
                <p class="mb-0 mt-1 opacity-75" style="font-size: 1.1rem;">Monitor aktivitas pengguna dalam sistem</p>
            </div>
        </div>
    </div>
                            ...
                            <tr>
                                <td>
                                    <span class="user-badge">
                                        <i class="fas fa-user me-2"></i>{{ $log->user->name }}
                                    </span>
                                </td>
                                <td>
                                    <span class="badge-activity bg-info text-white">
                            ...
                            <tr>
                                <td colspan="3">
                                    <div class="empty-state">
                                        ...
                                        <h5 class="mt-2">Tidak ada data aktivitas</h5>
