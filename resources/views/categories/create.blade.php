...
<body class="p-6">
    <div class="max-w-2xl mx-auto">
        <h1 class="page-title mb-8">
            <i class="fas fa-plus-circle mr-3 text-blue-600"></i>Tambah Kategori
        </h1>
        ...
        <div class="form-container">
            <form action="{{ route('categories.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" class="form-input" value="{{ old('name') }}" placeholder="Masukkan nama kategori">
                </div>
